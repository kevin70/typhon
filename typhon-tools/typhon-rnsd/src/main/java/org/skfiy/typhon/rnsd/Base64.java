 ...
 * boolean gzipCompressed )</tt>. Added the ability to "suspend" encoding in the Output Stream so
 * you can turn on and off the encoding if you need to embed base64 data in an otherwise "normal"
...
public class Base64 {
     ...
     * and returns a four-byte array in Base64 notation. The actual number of significant bytes in
     * your array is given by <var>numSigBytes</var>. The array <var>threeBytes</var> needs only be
     * as big as
     ...
     * <var>srcOffset</var> and <var>destOffset</var>. This method does not check to make sure your
     * arrays are large enough to accomodate <var>srcOffset</var> + 3 for the <var>source</var>
     * array or <var>destOffset</var> + 4 for the <var>destination</var> array. The actual number of
     * significant bytes in your array is given by <var>numSigBytes</var>.</p>
     * <p>
     ...
     * In earlier versions, it just returned a null value, but in retrospect that's a pretty poor
     * way to handle it.</p>
     *
     ...
     * and writes the resulting bytes (up to three of them) to <var>destination</var>. The source
     * and destination arrays can be manipulated anywhere along their length by specifying
     * <var>srcOffset</var> and <var>destOffset</var>. This method does not check to make sure your
     * arrays are large enough to accomodate <var>srcOffset</var> + 4 for the <var>source</var>
     * array or <var>destOffset</var> + 3 for the <var>destination</var> array. This method returns
