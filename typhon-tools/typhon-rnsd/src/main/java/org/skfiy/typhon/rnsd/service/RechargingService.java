...
public interface RechargingService {
     ...
     * @param json
     * @return
     * @throws TradeValidatedException
     */
    String recharge(JSONObject json) throws TradeValidatedException;
     ...
     * @throws TradeValidatedException
     */
    void giveZucks(JSONObject json) throws TradeValidatedException;
