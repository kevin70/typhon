 ...
 */
public class PvpReportPlayerEvent implements IPlayerEvent<PlayerEventBean> {

    @Override
    public String getEventName() {
        return IncidentConstants.EVENT_PVP_REPORT;
    }
    ...
    public void invoke(PlayerEventBean obj) {
        ...
        normal.addPvpReport(JSON.parseObject(incident.getData(), PvpReport.class));
    }
