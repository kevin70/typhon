 ...
 */
public class B_s028 extends BSaScript {
    ...
    private class MyBufferSkill extends FightObjectBufferSkill {
        ...
        protected Object begin() {
            ddef = (int) (fobj.getMaxDef() * 0.2);
            fobj.setDef(fobj.getDef() - ddef);
            return null;
        }
