 ...
 */
public class B_s063 extends BSaScript {
    ...
    private class MyBufferSkill extends FightObjectBufferSkill {
        ...
        protected Object begin() {
            p_atk = (int) (fobj.getMaxAtk() * 0.3);
            p_matk = (int) (fobj.getMaxMatk() * 0.3);

            d_mdef = (int) (fobj.getMaxMdef() * 0.2);

            fobj.setAtk(fobj.getAtk() + p_atk);
            fobj.setMatk(fobj.getMatk() + p_matk);

            fobj.setMdef(fobj.getMdef() - d_mdef);
            return null;
        }
