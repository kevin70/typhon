 ...
 */
public class B_s026 extends BSaScript {
    ...
    protected Object doExecute(BSaWapper bsaWapper) {
        ...
        for (FightObject goal : bsaWapper.getDefenderEntity().findFightGoals(bsaWapper.getBsaSkill().getNumOfTargets())) {
            ...
            r = warProvider.getCritMagn(aobj.getCritRate() + 0.15, goal.getDecritRate(), aobj.getCritMagn() + 0.5);
