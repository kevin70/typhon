 ...
 */
public class B_s048 extends BSaScript {
    ...
    protected Object doExecute(BSaWapper bsaWapper) {
        ...
        MyBufferSkill bufferSkill = new MyBufferSkill(bsaWapper.getWarInfo(), bsaWapper.getAttackerEntity().getDire(), aobj);
    ...
    private class MyBufferSkill extends FightObjectBufferSkill {
        ...
        protected Object begin() {
            fobj.setParryRate(fobj.getParryRate() + 0.2);
            fobj.setDecritRate(fobj.getDecritRate() + 0.2);
            return null;
        }
